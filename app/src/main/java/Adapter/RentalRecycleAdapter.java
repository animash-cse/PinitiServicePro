...
public class RentalRecycleAdapter extends RecyclerView.Adapter<RentalRecycleAdapter.MyViewHolder> {
    ...
    public RentalRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public RentalRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new RentalRecycleAdapter.MyViewHolder(itemView);
