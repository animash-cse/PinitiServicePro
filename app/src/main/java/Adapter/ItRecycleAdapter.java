...
public class ItRecycleAdapter extends RecyclerView.Adapter<ItRecycleAdapter.MyViewHolder> {
    ...
    public ItRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public ItRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new ItRecycleAdapter.MyViewHolder(itemView);
