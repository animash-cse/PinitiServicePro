...
public class EntertainmentRecycleAdapter extends RecyclerView.Adapter<EntertainmentRecycleAdapter.MyViewHolder> {
    ...
    public EntertainmentRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public EntertainmentRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new EntertainmentRecycleAdapter.MyViewHolder(itemView);
