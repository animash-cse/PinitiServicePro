...
public class ShoppingRecycleAdapter extends RecyclerView.Adapter<ShoppingRecycleAdapter.MyViewHolder> {
    ...
    public ShoppingRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public ShoppingRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new ShoppingRecycleAdapter.MyViewHolder(itemView);
