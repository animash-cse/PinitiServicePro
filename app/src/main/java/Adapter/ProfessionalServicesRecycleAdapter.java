...
public class ProfessionalServicesRecycleAdapter extends RecyclerView.Adapter<ProfessionalServicesRecycleAdapter.MyViewHolder> {
    ...
    public ProfessionalServicesRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public ProfessionalServicesRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new ProfessionalServicesRecycleAdapter.MyViewHolder(itemView);
