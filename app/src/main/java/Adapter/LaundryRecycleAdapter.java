...
public class LaundryRecycleAdapter extends RecyclerView.Adapter<LaundryRecycleAdapter.MyViewHolder> {
    ...
    public LaundryRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public LaundryRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new LaundryRecycleAdapter.MyViewHolder(itemView);
