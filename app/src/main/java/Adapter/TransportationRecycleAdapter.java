...
public class TransportationRecycleAdapter extends RecyclerView.Adapter<TransportationRecycleAdapter.MyViewHolder> {
    ...
    public TransportationRecycleAdapter(Context context, List<HomeCategoryModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public TransportationRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appliance_repair_list, parent, false);


        return new TransportationRecycleAdapter.MyViewHolder(itemView);
