...
import Adapter.RentalRecycleAdapter;
...
public class RentalFragment extends Fragment {
    ...
    private RentalRecycleAdapter bAdapter;
    ...
    private String title[] = {"Room","Shop","House","Accessories","Tools","Camera"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bAdapter = new RentalRecycleAdapter(getActivity(),homeCategoryModelClasses);
