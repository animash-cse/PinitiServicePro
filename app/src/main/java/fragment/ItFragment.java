...
import Adapter.ItRecycleAdapter;
...
public class ItFragment extends Fragment {
    ...
    private ItRecycleAdapter bAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_it, container, false);
        ...
        bAdapter = new ItRecycleAdapter(getActivity(),homeCategoryModelClasses);
