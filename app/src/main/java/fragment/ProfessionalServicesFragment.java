...
import Adapter.ProfessionalServicesRecycleAdapter;
import ModelClass.HomeCategoryModelClass;
import bd.piniti.service_pro.R;


public class ProfessionalServicesFragment extends Fragment {
    ...
    private ProfessionalServicesRecycleAdapter bAdapter;
    ...
    private String title[] = {"Lawyers","Media","Architects","Engineers","Teachers"};

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view =  inflater.inflate(R.layout.fragment_professional_services, container, false);
        ...
        bAdapter = new ProfessionalServicesRecycleAdapter(getActivity(),homeCategoryModelClasses);
