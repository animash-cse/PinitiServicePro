...
import Adapter.RestaurantRecycleAdapter;
...
public class RestaurantFragment extends Fragment {
    ...
    private RestaurantRecycleAdapter bAdapter;
    ...
    private String title[] = {"All","Rice Hotel","Vegetarian","Fast Food","Chinese Food","Sweet"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bAdapter = new RestaurantRecycleAdapter(getActivity(),homeCategoryModelClasses);
