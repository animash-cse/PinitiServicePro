...
import Adapter.ShoppingRecycleAdapter;
...
public class ShoppingFragment extends Fragment {
    ...
    private ShoppingRecycleAdapter bAdapter;
    ...
    private String title[] = {"Cosmetic","Shoes","Dresses","Jewelry","Grocery","Wedding Shopping","Eid Shopping","Puja Festival Shopping","Grocery"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bAdapter = new ShoppingRecycleAdapter(getActivity(),homeCategoryModelClasses);
