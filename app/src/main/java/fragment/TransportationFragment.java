...
import Adapter.TransportationRecycleAdapter;
...
public class TransportationFragment extends Fragment {
    ...
    private TransportationRecycleAdapter bAdapter;


    private  Integer image[] = {R.drawable.blocks_leakages,R.drawable.toilet_and_sanitary_work,R.drawable.bathroom_fitting,
            R.drawable.water_tank, R.drawable.full_home_health_check,R.drawable.water_tank,R.drawable.water_tank,R.drawable.full_home_health_check};
    private String title[] = {"Bike","Rickshaw","Motor Bike","Auto","Car","Bus","Truck","Ambulance"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bAdapter = new TransportationRecycleAdapter(getActivity(),homeCategoryModelClasses);
